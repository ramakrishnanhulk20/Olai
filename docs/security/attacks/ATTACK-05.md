...
```
GET http://127.0.0.1:54483/api/ledger/verify
...
```
Opened C:\Users\Ram\AppData\Local\Temp\olai-attack-05-eO2Foq\olai.db directly with better-sqlite3, outside the running agent,
