...
```
GET http://127.0.0.1:55059/api/ledger/verify
...
```
Opened C:\Users\Ram\AppData\Local\Temp\olai-attack-05-p77sr3\olai.db directly with better-sqlite3, outside the running agent,
