...
```
GET http://127.0.0.1:61971/api/ledger/verify
...
```
Opened C:\Users\Ram\AppData\Local\Temp\olai-attack-05-PFYlIX\olai.db directly with better-sqlite3, outside the running agent,
